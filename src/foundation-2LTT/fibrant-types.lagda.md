...
```agda
module foundation-2LTT.fibrant-types where
...
induced-map-hom-Fibrant-Type :
  ...
  type-Fibrant-Type (hom-Fibrant-Type A B) →
  witness-Fibrant-Type A → witness-Fibrant-Type B
induced-map-hom-Fibrant-Type A B f a =
  witness-exotype-Fibrant-Type B (f (exotype-witness-Fibrant-Type A a))
