...
```agda
module species.dirichlet-exponentials-species-of-types-in-subuniversesᵉ where
```
...
open import foundation.pi-decompositions-subuniverseᵉ
...
open import species.dirichlet-exponentials-species-of-typesᵉ
...
Theᵉ **Dirichletᵉ exponential**ᵉ ofᵉ aᵉ speciesᵉ `Sᵉ : Pᵉ → Q`ᵉ ofᵉ typesᵉ in subuniverseᵉ
isᵉ definedᵉ byᵉ

```text
  Xᵉ ↦ᵉ Σᵉ ((Uᵉ ,ᵉ Vᵉ ,ᵉ eᵉ) : Π-Decomposition-subuniverseᵉ Pᵉ X),ᵉ  Πᵉ (uᵉ : Uᵉ) → Sᵉ (Vᵉ u).ᵉ
```

Ifᵉ `Q`ᵉ isᵉ aᵉ globalᵉ subuniverse,ᵉ andᵉ ifᵉ theᵉ previousᵉ definitionᵉ isᵉ in `Q`,ᵉ thenᵉ
theᵉ Dirichletᵉ exponentialᵉ isᵉ alsoᵉ aᵉ speciesᵉ ofᵉ typesᵉ in subuniverseᵉ fromᵉ `P`ᵉ to
`Q`.ᵉ
...
module _
  ...
  type-dirichlet-exponential-species-subuniverseᵉ :
    (Sᵉ : species-subuniverseᵉ Pᵉ (subuniverse-global-subuniverseᵉ Qᵉ l3ᵉ))
    (Xᵉ : type-subuniverseᵉ Pᵉ) → UUᵉ (lsuc l1ᵉ ⊔ l2ᵉ ⊔ l3ᵉ)
  type-dirichlet-exponential-species-subuniverseᵉ Sᵉ Xᵉ =
    Σᵉ ( Π-Decomposition-Subuniverseᵉ Pᵉ Xᵉ)
      ( λ Dᵉ →
        ( bᵉ : indexing-type-Π-Decomposition-Subuniverseᵉ Pᵉ Xᵉ Dᵉ) →
        ( inclusion-subuniverseᵉ
            ( subuniverse-global-subuniverseᵉ Qᵉ l3ᵉ)
            ( Sᵉ (subuniverse-cotype-Π-Decomposition-Subuniverseᵉ Pᵉ Xᵉ Dᵉ bᵉ))))
```

### Subuniverses closed under the Dirichlet exponential of a species in a subuniverse

```agda
is-closed-under-dirichlet-exponential-species-subuniverseᵉ :
  {l1ᵉ l2ᵉ : Level} (Pᵉ : subuniverseᵉ l1ᵉ l2ᵉ) (Qᵉ : global-subuniverseᵉ (λ lᵉ → lᵉ)) →
  UUωᵉ
is-closed-under-dirichlet-exponential-species-subuniverseᵉ {l1ᵉ} {l2ᵉ} Pᵉ Qᵉ =
  {l3ᵉ : Level}
  (Sᵉ : species-subuniverseᵉ Pᵉ (subuniverse-global-subuniverseᵉ Qᵉ l3ᵉ))
  (Xᵉ : type-subuniverseᵉ Pᵉ) →
  is-in-subuniverseᵉ
    ( subuniverse-global-subuniverseᵉ Qᵉ (lsuc l1ᵉ ⊔ l2ᵉ ⊔ l3ᵉ))
    ( type-dirichlet-exponential-species-subuniverseᵉ Pᵉ Qᵉ Sᵉ Xᵉ)
```
...
module _
  {l1ᵉ l2ᵉ l3ᵉ : Level} (Pᵉ : subuniverseᵉ l1ᵉ l2ᵉ) (Qᵉ : global-subuniverseᵉ (λ lᵉ → lᵉ))
  ( C1ᵉ : is-closed-under-dirichlet-exponential-species-subuniverseᵉ Pᵉ Qᵉ)
  where

  dirichlet-exponential-species-subuniverseᵉ :
  ...
  pr1ᵉ (dirichlet-exponential-species-subuniverseᵉ Sᵉ Xᵉ) =
    type-dirichlet-exponential-species-subuniverseᵉ Pᵉ Qᵉ Sᵉ Xᵉ
  pr2ᵉ (dirichlet-exponential-species-subuniverseᵉ Sᵉ Xᵉ) = C1ᵉ Sᵉ Xᵉ
```
...
module _
  ...
  ( C2ᵉ :
    ...
    is-in-subuniverseᵉ Pᵉ (Πᵉ Uᵉ Vᵉ) → is-in-subuniverseᵉ Pᵉ Uᵉ)
  ( Sᵉ : species-subuniverseᵉ Pᵉ (subuniverse-global-subuniverseᵉ Qᵉ l3ᵉ))
  ( Xᵉ : type-subuniverseᵉ Pᵉ)
  where
  ...
  private
    reassociateᵉ :
      Σ-extension-species-subuniverseᵉ
        ( Pᵉ)
        ( subuniverse-global-subuniverseᵉ Qᵉ (lsuc l1ᵉ ⊔ l2ᵉ ⊔ l3ᵉ))
        ( dirichlet-exponential-species-subuniverseᵉ Pᵉ Qᵉ C1ᵉ Sᵉ)
        ( inclusion-subuniverseᵉ Pᵉ Xᵉ) ≃ᵉ
      Σᵉ ( Π-Decompositionᵉ l1ᵉ l1ᵉ (inclusion-subuniverseᵉ Pᵉ Xᵉ))
        ( λ (Uᵉ ,ᵉ Vᵉ ,ᵉ eᵉ) →
    ...
    reassociate'ᵉ :
      Σᵉ ( Π-Decompositionᵉ l1ᵉ l1ᵉ (inclusion-subuniverseᵉ Pᵉ Xᵉ))
        ( λ dᵉ →
          Σᵉ ( ( uᵉ : (indexing-type-Π-Decompositionᵉ dᵉ)) →
              is-in-subuniverseᵉ Pᵉ (cotype-Π-Decompositionᵉ dᵉ uᵉ))
            ( λ pᵉ →
              ( ( uᵉ : indexing-type-Π-Decompositionᵉ dᵉ) →
                inclusion-subuniverseᵉ
                  ( subuniverse-global-subuniverseᵉ Qᵉ l3ᵉ)
                  ( Sᵉ (cotype-Π-Decompositionᵉ dᵉ uᵉ ,ᵉ pᵉ uᵉ)))))
        ≃ᵉ
  ...
  equiv-dirichlet-exponential-Σ-extension-species-subuniverseᵉ :
    Σ-extension-species-subuniverseᵉ
      ( Pᵉ)
      ( subuniverse-global-subuniverseᵉ Qᵉ (lsuc l1ᵉ ⊔ l2ᵉ ⊔ l3ᵉ))
      ( dirichlet-exponential-species-subuniverseᵉ Pᵉ Qᵉ C1ᵉ Sᵉ)
          ...
          equiv-Σ-equiv-baseᵉ
            ...
            ( ( inv-equivᵉ
                ( equiv-add-redundant-propᵉ
                  ( is-prop-type-Propᵉ
                    ( Pᵉ (indexing-type-Π-Decompositionᵉ dᵉ)))
                  ( λ pVᵉ →
                    C2ᵉ
                      ( indexing-type-Π-Decompositionᵉ dᵉ)
                      ( cotype-Π-Decompositionᵉ dᵉ)
                      ( pVᵉ)
                      ( trᵉ
                        ( is-in-subuniverseᵉ Pᵉ)
                        ( eq-equivᵉ (matching-correspondence-Π-Decompositionᵉ dᵉ))
                        ( pr2ᵉ Xᵉ))))) ∘eᵉ
...
module _
  ...
  ( C4ᵉ :
    ...
    ( Vᵉ : Uᵉ → UUᵉ l1ᵉ) →
    ( (uᵉ : Uᵉ) → is-in-subuniverseᵉ Pᵉ (Vᵉ uᵉ)) →
      ( is-in-subuniverseᵉ Pᵉ (Πᵉ Uᵉ Vᵉ)) →
      ( is-in-subuniverseᵉ Pᵉ Uᵉ))
  ( C5ᵉ : is-closed-under-products-subuniverseᵉ Pᵉ)
  ( C6ᵉ :
    ( Aᵉ Bᵉ : UUᵉ l1ᵉ) →
  ...
  equiv-dirichlet-exponential-sum-species-subuniverseᵉ :
    inclusion-subuniverseᵉ
      ( subuniverse-global-subuniverseᵉ Qᵉ (lsuc l1ᵉ ⊔ l2ᵉ ⊔ l3ᵉ ⊔ l4ᵉ))
      ( dirichlet-exponential-species-subuniverseᵉ Pᵉ Qᵉ C1ᵉ
        ( coproduct-species-subuniverseᵉ Pᵉ Qᵉ C2ᵉ Sᵉ Tᵉ) Xᵉ) ≃ᵉ
    inclusion-subuniverseᵉ
      ( subuniverse-global-subuniverseᵉ Qᵉ (lsuc l1ᵉ ⊔ l2ᵉ ⊔ l3ᵉ ⊔ l4ᵉ))
      ( dirichlet-product-species-subuniverseᵉ Pᵉ Qᵉ C3ᵉ
        ( dirichlet-exponential-species-subuniverseᵉ Pᵉ Qᵉ C1ᵉ Sᵉ)
        ( dirichlet-exponential-species-subuniverseᵉ Pᵉ Qᵉ C1ᵉ Tᵉ)
        ( Xᵉ))
  equiv-dirichlet-exponential-sum-species-subuniverseᵉ =
    ( ( inv-equivᵉ
                  ...
                  equiv-Πᵉ
                    ...
                    ( λ xᵉ →
                      equiv-coproduct-Σ-extension-species-subuniverseᵉ
                        ...
                        ( Sᵉ)
                        ( Tᵉ)
                        ( cotype-Π-Decompositionᵉ dᵉ xᵉ)))) ∘eᵉ
              ( ( equiv-dirichlet-exponential-Σ-extension-species-subuniverseᵉ
                  ( Pᵉ)
                  ( Qᵉ)
                  ( C1ᵉ)
    ...
    lemma-C6ᵉ =
      λ dᵉ →
      C6ᵉ
        ( left-summand-binary-product-Decompositionᵉ dᵉ)
        ( right-summand-binary-product-Decompositionᵉ dᵉ)
        ( trᵉ
          ( is-in-subuniverseᵉ Pᵉ)
          ( eq-equivᵉ (matching-correspondence-binary-product-Decompositionᵉ dᵉ))
          ( pr2ᵉ Xᵉ))
```